<x-guest-layout>
    <x-authentication-card>
        ...
        <h1 class="font-medium text-2xl text-green-600 text-center mb-4">Farmer Login</h1>
        <div class="text-sm">
            ...
            <form method="POST" action="{{ route('auth.login') }}">
                ...
                <div class="register-link mt-6 text-center text-custom-green">
                    ...
                    <br>
                    <p>Are you already registered as an Instructor? <a href="/instructor/login" class="underline hover:text-custom-green-hover">Log In</a></p>
                </div>
            </form>
