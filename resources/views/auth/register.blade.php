<x-guest-layout>
    <x-authentication-card>
        ...
        <h1 class="font-medium text-2xl text-green-600 text-center mb-4">Farmer Registration</h1>
        <div class="text-sm">
            ...
            <form method="POST" action="{{ route('register') }}" class="w-full max-w-xl mx-auto">
                @csrf
                ...
                <div class="flex flex-col items-center justify-center mt-5">
                    ...
                    <a class="underline text-sm text-gray-600 hover:text-gray-900 mt-4" href="/instructor/register">
                        {{ __('if you are an Instructor, Register Here !!!') }}
                    </a>
                </div>
            </form>
